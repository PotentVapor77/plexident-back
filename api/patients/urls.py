...
from .views import AnamnesisGeneralViewSet, AntecedentesFamiliaresViewSet, AntecedentesPersonalesViewSet, ConstantesVitalesViewSet, ExamenEstomatognaticoViewSet, PacienteViewSet
