...
from .views import AntecedentesFamiliaresViewSet, AntecedentesPersonalesViewSet, ConstantesVitalesViewSet, ExamenEstomatognaticoViewSet, ExamenesComplementariosViewSet, PacienteViewSet
...
router.register(r'examenes-complementarios', ExamenesComplementariosViewSet, basename='examenes-complementarios')
