...
class FHIRViewSet(viewsets.ViewSet):
    ...
    def odontograma(self, request, paciente_id=None):
        ...
        try:
            ...
            # Obtener diagnÃ³sticos del odontograma
            ...
            logger.info(f"FHIR Odontograma Bundle GET: paciente={paciente_id}, entries={len(bundle['entry'])}")
    ...
    def validate(self, request):
        ...
        try:
            ...
            if not resource or not profile:
                return Response(
                    {'error': 'Requiere "resource" y "profile"'},
            ...
            logger.error(f"Error en validaciÃ³n FHIR: {str(e)}")
            return Response(
                {
                    'valid': False,
                    'issues': [str(e)]
    ...
    def search(self, request):
        ...
        Buscar recursos FHIR segÃºn parÃ¡metros
        """
        try:
            ...
            logger.error(f"Error en bÃºsqueda FHIR: {str(e)}")
            return Response(
                {
                    'resourceType': 'OperationOutcome',
                    'issue': [{
